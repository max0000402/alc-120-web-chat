...
export default function LandingComponent() {
    return (
        <Container>
            <h1 className="landing-title">MyRoom - Оставайтесь на связи с друзьями и близкими
		...
		l0.009,0.009C40.634,8.566,44.134,7,48,7c7.732,0,14,6.268,14,14C62,24.424,60.755,27.545,58.714,29.977z"/>
            ...
            <Row>
                <Col sm={3}>
                    <Card>
                        <Card.Header>
                            <Card.Title>Удобство использования</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            Приложение обладает удобным и быстрым интерфейсом, который позволяет легко общаться с другими пользователями.
                        </Card.Body>
                    </Card>
                </Col>
                <Col sm={3}>
                    <Card>
                        <Card.Header>
                            <Card.Title>Широкие возможности</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            Приложение позволяет удобно организовывать общение, делиться текстовыми сообщениями.
                        </Card.Body>
                    </Card>
                </Col>
                <Col sm={3}>
                    <Card>
                        <Card.Header>
                            <Card.Title>Бесплатность</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            Приложение является бесплатным для использования и не требует дополнительных платежей за функционал.
                        </Card.Body>
                    </Card>
                </Col>
                <Col sm={3}>
                    <Card>
                        <Card.Header>
                            <Card.Title>Доступность</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            К приложению может быть получен доступ с любого популярного* устройства
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
